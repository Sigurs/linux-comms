...
- [ ] 5.1 Send a DM to a RocketChat account while that profile is not active and verify the sidebar badge appears
- [ ] 5.2 Switch to the RocketChat profile and verify the badge clears
- [ ] 5.3 Verify Teams badge behaviour is unchanged
